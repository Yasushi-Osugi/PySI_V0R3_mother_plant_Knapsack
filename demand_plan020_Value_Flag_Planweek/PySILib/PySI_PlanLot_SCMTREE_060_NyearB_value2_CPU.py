...
#@220629 profileのnode名称群が l[0,1,2,3]
#        self.product_name           = plan_prof['product_name']
#        self.SC_tree_id             = plan_prof['SC_tree_id']
#        self.node_from              = plan_prof['node_from']
#        self.node_to                = plan_prof['node_to']
...
# *********************************************
                ...
                #print('error:PSI_data unkown data without S-CO-I-P-IP',l[5])
...
#@221009 lot_noの持ち方を[lot_no,lot_value]のリストにして、出し入れする。
#        lot_noは、色々と使っているので、
#        lot_no_valueというペアリストを新しく定義する。
#        class PlanSpaceに、lot_no, lot_value, lot_no_valueを定義したが???
#        class LotSpaceにも、lot_no, lot_value, lot_no_valueを定義する???
...
# ******************************
# read profile DB CSV #@220924 作りかけ ココはpandasで上位で書く?
# ******************************
